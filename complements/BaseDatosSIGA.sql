...
ALTER TABLE categoria_productos
  ADD COLUMN IF NOT EXISTS fraccion_arancelaria CHAR(10) NULL
    COMMENT 'Código TIGIE 8 dígitos (fracción arancelaria SA). Ej: 85165001';

-- Fracciones TIGIE por categoría (8 dígitos, sin NICO)
UPDATE categoria_productos SET fraccion_arancelaria = '85165001' WHERE numero = 1;  -- Electrodomésticos      (aparatos electrotérmicos)
UPDATE categoria_productos SET fraccion_arancelaria = '52081101' WHERE numero = 2;  -- Textiles               (telas de algodón)
UPDATE categoria_productos SET fraccion_arancelaria = '39011001' WHERE numero = 3;  -- Insumos Industriales   (polietileno gránulo)
UPDATE categoria_productos SET fraccion_arancelaria = '64011001' WHERE numero = 4;  -- Calzado                (calzado impermeable)
UPDATE categoria_productos SET fraccion_arancelaria = '84571001' WHERE numero = 5;  -- Maquinaria             (centros de mecanizado)
UPDATE categoria_productos SET fraccion_arancelaria = '85423101' WHERE numero = 6;  -- Componentes Elect.     (circuitos integrados)
UPDATE categoria_productos SET fraccion_arancelaria = '22083001' WHERE numero = 7;  -- Bebidas Alcohólicas    (whisky)
UPDATE categoria_productos SET fraccion_arancelaria = '73012001' WHERE numero = 8;  -- Acero y Metales        (perfiles de acero)
UPDATE categoria_productos SET fraccion_arancelaria = '07099901' WHERE numero = 9;  -- Productos Agropecuarios(hortalizas frescas)
UPDATE categoria_productos SET fraccion_arancelaria = '87032301' WHERE numero = 10; -- Vehículos              (automóviles gasolina)
UPDATE categoria_productos SET fraccion_arancelaria = '30049001' WHERE numero = 11; -- Productos Farmacéuticos(medicamentos)
UPDATE categoria_productos SET fraccion_arancelaria = '16025001' WHERE numero = 12; -- Alimentos Procesados   (conservas de carne)
UPDATE categoria_productos SET fraccion_arancelaria = '29011001' WHERE numero = 13; -- Químicos Industriales  (hidrocarburos acíclicos)
UPDATE categoria_productos SET fraccion_arancelaria = '85444201' WHERE numero = 14; -- Material Eléctrico     (cables conductores)
UPDATE categoria_productos SET fraccion_arancelaria = '39201001' WHERE numero = 15; -- Plásticos y Hules      (placas de polímeros)
UPDATE categoria_productos SET fraccion_arancelaria = '33030001' WHERE numero = 16; -- Cosméticos y Perfumería(perfumes)
UPDATE categoria_productos SET fraccion_arancelaria = '21069001' WHERE numero = 17; -- Suplementos Aliment.   (preparaciones alimenticias)
UPDATE categoria_productos SET fraccion_arancelaria = '90181901' WHERE numero = 18; -- Equipos Médicos        (instrumentos médicos)
UPDATE categoria_productos SET fraccion_arancelaria = '93019001' WHERE numero = 19; -- Material Bélico        (armas militares)
UPDATE categoria_productos SET fraccion_arancelaria = '90058001' WHERE numero = 20; -- Equipo Óptico y Visión (binoculares)
UPDATE categoria_productos SET fraccion_arancelaria = '01012901' WHERE numero = 21; -- Animales Vivos         (animales vivos)
UPDATE categoria_productos SET fraccion_arancelaria = '10011901' WHERE numero = 22; -- Semillas y Granos      (trigo)
UPDATE categoria_productos SET fraccion_arancelaria = '95030001' WHERE numero = 23; -- Juguetes y Art. Infant.(juguetes)
UPDATE categoria_productos SET fraccion_arancelaria = '59119001' WHERE numero = 24; -- Textiles Técnicos      (textiles para uso técnico)
UPDATE categoria_productos SET fraccion_arancelaria = '31052001' WHERE numero = 25; -- Fertilizantes/Agroquím.(fertilizantes minerales)
UPDATE categoria_productos SET fraccion_arancelaria = '27101201' WHERE numero = 26; -- Combustibles y Lubric. (aceites de petróleo)
UPDATE categoria_productos SET fraccion_arancelaria = '44071001' WHERE numero = 27; -- Madera y Prod. Forestales(madera aserrada)
UPDATE categoria_productos SET fraccion_arancelaria = '48041101' WHERE numero = 28; -- Papel y Cartón         (papel kraft)
UPDATE categoria_productos SET fraccion_arancelaria = '92029001' WHERE numero = 29; -- Instrumentos Musicales (instrumentos de cuerda)
UPDATE categoria_productos SET fraccion_arancelaria = '95069901' WHERE numero = 30; -- Artículos Deportivos   (artículos deportivos)
